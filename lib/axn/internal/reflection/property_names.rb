    ...
    module Reflection
      ...
      module PropertyNames
        ...
        def reject_colliding_emitted_properties!(schema, &sources)
          ...
          each_emitted_node(schema) do |path, property_names|
            ...
            property_names.each do |name|
              ...
              canonical = canonicals[name] = Axn::Internal::Reflection::Values.canonical_wire_key(name)
        ...
        def raise_colliding_properties!(path, canonical, first_name, second_name, sources, canonicals)
          ...
          segments = path.map { |segment| canonicals.fetch(segment) { Axn::Internal::Reflection::Values.canonical_wire_key(segment) } }
        ...
        def property_sources_for(config, wire_path, model_id:)
          ...
          plan = Axn::Internal::Reflection::Schema.shape_property_plan(config, for_output: !model_id)
