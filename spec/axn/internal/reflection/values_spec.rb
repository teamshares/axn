...
RSpec.describe Axn::Internal::Reflection::Values do
  ...
  describe ".serialize_value" do
    ...
    it "serializes a Symbol as its String form (matching TYPE_MAP's Symbol => \"string\")" do
      ...
      # `type: Symbol` => "string" mapping (Axn::Internal::Reflection::Schema::TypeTokens::TYPE_MAP), not fall through
    ...
    it "serializes other Numeric subclasses (BigDecimal, Rational) as JSON numbers (Float), matching the schema's number type" do
      ...
      # output_schema declaring `type: Numeric` => "number" (Axn::Internal::Reflection::Schema::TypeTokens::TYPE_MAP).
    ...
    it "serializes Time/DateTime/Date as ISO-8601/RFC3339 strings, matching the schema's date/date-time format" do
      ...
      # (Axn::Internal::Reflection::Schema::TypeTokens::FORMAT_MAP). They must serialize identically whether or not
